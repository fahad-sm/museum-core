...
class ContactUrl extends Tag {
	...
	public function get_name() {
		return 'WE_Contact_Url';
	}

	public function get_title() {
		return __( 'Contact URL', 'museum-core' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'sms'              => __( 'SMS', 'museum-core' ),
					'whatsapp'         => __( 'WhatsApp', 'museum-core' ),
					'skype'            => __( 'Skype', 'museum-core' ),
					'messenger'        => __( 'Messenger', 'museum-core' ),
					'viber'            => __( 'Viber', 'museum-core' ),
					'waze'             => __( 'Waze', 'museum-core' ),
					'google_calendar'  => __( 'Google Calendar', 'museum-core' ),
					'outlook_calendar' => __( 'Outlook Calendar', 'museum-core' ),
					'yahoo_calendar'   => __( 'Yahoo Calendar', 'museum-core' ),
				],
			]
		);
		...
		$this->add_control(
			'viber_action',
			[
				'label'     => __( 'Action', 'museum-core' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'contact' => __( 'Contact', 'museum-core' ),
					'add'     => __( 'Add', 'museum-core' ),
				],
				'default'   => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'call'      => __( 'Call', 'museum-core' ),
					'chat'      => __( 'Chat', 'museum-core' ),
					'userinfo'  => __( 'Show Profile', 'museum-core' ),
					'add'       => __( 'Add to Contacts', 'museum-core' ),
					'voicemail' => __( 'Send Voice Mail', 'museum-core' ),
				],
				'default'   => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'event_description',
			[
				'label'     => __( 'Description', 'museum-core' ),
				'type'      => Controls_Manager::TEXTAREA,
				'condition' => [
					'link_type' => [
						'google_calendar',
