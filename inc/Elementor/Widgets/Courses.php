...
class Courses extends Widget_Base {
    ...
    public function get_name() {
        return 'museum_core_courses';
    }

    public function get_title() {
        return esc_html__( 'Courses Carousel', 'museum-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
           'student_course_posts_content_carousel_section',
           [
    ...
    public function render() {
        ...
        extract($settings);
        include STUDENT_PLUGIN_PATH . 'templates/elementor/courses.php';
    }
}
