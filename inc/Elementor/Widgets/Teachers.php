...
class Teachers extends Widget_Base {
    ...
    public function get_name() {
        return 'museum_core_teachers';
    }

    public function get_title() {
        return esc_html__( 'Teachers & Trainers', 'museum-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
           ...
           [
               'label' => esc_html__( 'General', 'museum-core' ),
           ]
        );
       ...
       $this->add_control(
           'posts_manual_selection',
           [
               'label' =>esc_html__('Search & Select', 'museum-core'),
               'type'      => ControlsManager::AJAXSELECT2,
               'options'   =>'action=museum_core_ajax&subaction=ajaxselect2&data=post&type=teacher',
               'label_block' => true,
               'multiple'  => true,
    ...
    public function render() {
        ...
        extract($settings);
        include STUDENT_PLUGIN_PATH . 'templates/elementor/teachers.php';
    }
}
